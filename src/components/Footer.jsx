...
const Footer = () => {
  ...
  return (
    <div className="flex flex-col font-nunito items-center justify-center gap-8 py-16 relative bg-[url(/images/footer.jpg)] bg-cover ">
      <div
        onClick={handleMailTo}
        className=" flex items-center justify-around    self-stretch w-full h-fit cursor-pointer  text-white hover:text-blue-500     font-black text-xl lg:text-3xl xl:text-5xl "
      >
        <div className="flex font-nunito items-center justify-center w-40  lg:w-96 h-auto    backdrop-blur-xl  md:p-2">
          Mail Us :
        </div>
        <div className="flex justify-evenly h-auto w-full  rounded-lg overflow-hidden   md:mx-8 md:p-2">
          {characters.map((char, index) => (
            <span className="font-kanit uppercase" key={index}>
              {char}
            </span> // Map and print each character
          ))}
        </div>
      </div>
      <div className="grid gap-4 grid-cols-1 md:grid-cols-2  justify-between items-center   px-16 py-8 relative self-stretch  ml-[-1.00px] mr-[-1.00px] border-t [border-top-style:solid] border-white/80">
        <div className="inline-flex flex-col  gap-2 relative  ">
          ...
          <div className="w-full font-kanit   font-bold  text-2xl  md:text-4xl ">
        ...
        >
          <div className="flex flex-col  items-start gap-4 relative w-full ">
            <div className="flex items-center gap-2.5 px-4 py-2 relative self-stretch w-full   xl:w-80 bg-white/5 rounded-lg overflow-hidden border-[0.25px] border-solid border-white/40 backdrop-blur-xl  ">
              <div className="relative w-fit  text-white/80 text-xs ">
                Example name
              </div>
            </div>
            <div className="flex items-center gap-2.5 px-4 py-2 relative self-stretch w-full xl:w-80 bg-white/5 rounded-lg overflow-hidden border-[0.25px] border-solid border-white/40 backdrop-blur-xl  ">
          ...
          <div className="flex flex-col items-start gap-4 relative w-full">
            ...
            <div className="flex items-center justify-center gap-2.5 px-[21px] py-1 relative self-stretch w-full xl:w-80 bg-[#00000080] rounded-lg overflow-hidden backdrop-blur-xl  ">
              <div className="relative font-kanit w-fit  font-black text-white/90 text-xl ">
                Submit
              </div>
            </div>
          </div>
      ...
      <div className="flex flex-col gap-4 md:flex-row md:gap-0 items-center justify-between px-16 py-8 relative self-stretch w-full border-t [border-top-style:solid] border-white/80">
        <div className="inline-flex items-center justify-center relative bg-white/5  rounded-lg overflow-hidden backdrop-blur-xl  ">
          <div className="inline-flex flex-col items-start justify-center gap-1 px-4 py-2 relative rounded-lg overflow-hidden">
            <a className="relative w-fit font-kanit  text-white/80 text-xs ">
              CALL US
            </a>
          ...
          <div className="inline-flex w-fit flex-col items-start justify-center gap-1 px-4 py-2 relative rounded-lg overflow-hidden">
            <div className="relative w-fit font-kanit text-white/80 text-xs ">
              VISIT US
            </div>
        ...
        <div className="inline-flex items-center justify-center gap-8 p-4 relative bg-white/5 rounded-lg overflow-hidden backdrop-blur-xl  ">
          <p className="relative w-fit   text-white/80 text-xs ">
            Copyright 2024 VP. All rights reserved.
          </p>
        </div>
        <div className="inline-flex items-center justify-center gap-8 p-4 relative bg-white/5 rounded-lg overflow-hidden backdrop-blur-xl  ">
          <div className="relative w-fit    text-xs ">Privacy</div>
          <div className="relative w-fit    text-xs ">
            Terms &amp; Conditions
          </div>
          <div className="relative w-fit    text-xs ">Security</div>
        </div>
      </div>
    </div>
  );
