...
const Hero = () => {
  return (
    <div className="  w-full h-fit font-kanit font-bold ">
      ...
      <div className="absolute top-0 left-0 w-full h-screen z-20 flex items-center justify-center">
        <div className="h-screen w-screen py-10 relative flex flex-col ">
          <div className="relative z-10 flex flex-col items-center ">
            <span className="text-2xl sm:text-3xl md:text-4xl  text-center font-head">
              Vision Peak
            </span>
          </div>
        </div>
      ...
      <div className="absolute top-1/2 transform -translate-y-1/2  w-full  ">
        <div className="flex flex-col  items-center  ">
          ...
          <div className="  text-sm md:text-base xl:text-2xl  text-white/75 ">
